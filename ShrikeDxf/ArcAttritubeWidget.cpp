	...
	m_arc()
{
	...
	connect(ui.doubleSpinBox_StartAngle_DEG, QOverload<double>::of(&QDoubleSpinBox::valueChanged), this, &CArcAttritubeWidget::OnSpinBoxChanged);
	connect(ui.doubleSpinBox_StartAngle_DEG, &QDoubleSpinBox::editingFinished, this, &CArcAttritubeWidget::OnSpinBoxChanged);
	connect(ui.doubleSpinBox_EndAngle_DEG, QOverload<double>::of(&QDoubleSpinBox::valueChanged), this, &CArcAttritubeWidget::OnSpinBoxChanged);
